...
let availableMessages = [
    { text: " yayımı beğendiğinde resmin büyüyor", language: "tr" },
    ...
    { text: " yayımı paylaşdığında resmin büyüyor", language: "tr" },
    ...
    { text: " sayfamı takip etdiğinde resmin büyüyor", language: "tr" },
...
connection.on('gift', (data) => {
    ...
    const messages = [
        ...
        { text: "999 yazanları takipe alıyoruz", language: "tr" },
        ...
        { text: " yat bu yuhudan oyanma bir addımda yakınlaş", language: "tr" },
            { text: "lift yıkan evi matı yıka bilmir", language: "tr" },    
